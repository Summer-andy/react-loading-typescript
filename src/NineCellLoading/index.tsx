...
const LoadContainer = styled.div`
  height: calc(
    ${props => sizeContainer[props.size] || sizeContainer['default']} * 2
  );
  width: calc(
    ${props => sizeContainer[props.size] || sizeContainer['default']} * 2
  );
...
const Item = styled.div`
  height: calc(
    ${props => sizeContainer[props.size] || sizeContainer['default']} / 4
  );
  width: calc(
    ${props => sizeContainer[props.size] || sizeContainer['default']} / 4
  );
  ...
  border-radius: 50%;
  animation: ${animate} ${props => props.speed || 1.5}s alternate ease-in-out
    infinite;
`;
